...
public class ChessGame {
    ...
    private void initializePieces() {
        ...
        for (int col = 0; col < 8; col++) {
            board.setPiece(1, col, new Pawn(PieceColor.BLACK, new Position(1, col)));
            board.setPiece(6, col, new Pawn(PieceColor.WHITE, new Position(6, col)));
            System.out.println("Placed Black Pawn at (1, " + col + ")");
            System.out.println("Placed White Pawn at (6, " + col + ")");
        }
        // Set up other pieces...
    }
}
